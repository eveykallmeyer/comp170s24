public class FinalAssignment{
    ...
    public static void main(String[] args) {
        ...
        int[] cousinsAges = merge(left, right);
    ...
    // merge method to return a single sorted array that was merged from merge two original arrays.
    public static int[] merge(int[] left, int[] right){

        int[] cousinsAges = new int[left.length + right.length];
        int i=0, j=0, k=0;
